...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('student.general.test.submit') }}" method="post" id="testForm">
            @csrf
                            ...
                            <div class="options">
                                @foreach ($question->options->shuffle() as $option)
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="answer_{{ $option->id }}">({{ $alp[$n++] }}). {{ $option->option_text }}</label>
                                    </div>
                                @endforeach
                            </div>
                            <hr>
