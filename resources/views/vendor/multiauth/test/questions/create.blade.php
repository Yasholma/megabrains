                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <div class="card p-3">
                                <form action="{{ route('admin.questions.store', $test->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <a href="{{ route('admin.questions.show', [$test->id]) }}" class="btn btn-outline-warning">Back</a>
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.questions.show', [$test->id]) }}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-chevron-double-left"></i>Back To Questions</a>
                        </div>
                    </div>
                </div>
            </div>
