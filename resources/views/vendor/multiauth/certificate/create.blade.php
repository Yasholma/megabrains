                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="card p-4">
                                <form action="{{ route('admin.certificate.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="certificate_id" id="certificate_id" class="form-control {{ $errors->has('certificate_id') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="student_name" id="student_name" class="form-control {{ $errors->has('student_name') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="course_name" id="course_name" class="form-control {{ $errors->has('course_name') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="grade" id="grade" class="form-control {{ $errors->has('grade') ? ' is-invalid' : '' }}">
                                                @if ($errors->has('grade'))
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <hr>
                                                <img src="" id="img_prev" alt="" width="200" height="200" class="rounded rounded-circle" style="border: none;">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <a href="{{ route('admin.certificate') }}" class="btn btn-outline-warning">Back</a>
